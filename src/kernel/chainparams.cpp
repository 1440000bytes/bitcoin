...
public:
    CMainParams() {
        ...
        // CT: output format changes the genesis; legacy hash assert disabled. assert(consensus.hashGenesisBlock == uint256{"000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"});
        // CT: output format changes the genesis; legacy hash assert disabled. assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        // CT: output format changes the genesis; legacy hash assert disabled. assert(consensus.hashGenesisBlock == uint256{"000000000933ea01ad0ee984209779baaec3ced90fa3f408719526f8d77f4943"});
        // CT: output format changes the genesis; legacy hash assert disabled. assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});
...
public:
    CTestNet4Params() {
        ...
        genesis = CreateGenesisBlock(testnet4_genesis_msg,
                ...
                50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // CT: output format changes the genesis; legacy hash assert disabled. assert(consensus.hashGenesisBlock == uint256{"00000000da84f2bafbbc53dee25a72ae507ff4914b867c565be350b0da8bf043"});
        // CT: output format changes the genesis; legacy hash assert disabled. assert(genesis.hashMerkleRoot == uint256{"7aa0a7ae1e223414cb807e40cd57e667b718e42aaf9306db9102fe28912b7b4e"});
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        // CT: output format changes the genesis; legacy hash assert disabled. assert(consensus.hashGenesisBlock == uint256{"00000008819873e925422c1ff0f99f7cc9bbb232af63a077a480a3633bee1ef6"});
        // CT: output format changes the genesis; legacy hash assert disabled. assert(genesis.hashMerkleRoot == uint256{"4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"});
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        // CT changes the output serialization, so the regtest genesis is recomputed.
        assert(consensus.hashGenesisBlock == uint256{"6667f5812e922de8fba019a963f918cb736671202ffd75727036a282cef8a009"});
